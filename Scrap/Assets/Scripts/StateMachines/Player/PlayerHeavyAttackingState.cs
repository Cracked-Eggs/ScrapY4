public class PlayerHeavyAttackingState : PlayerBaseState
{
    ...
    public PlayerHeavyAttackingState(PlayerStateMachine stateMachine, int attackIndex) : base(stateMachine) => attack = stateMachine.HeavyAttack[attackIndex];
    ...
    public override void Enter()
    {
        ...
        stateMachine.AudioManager.PlayHeavyAttack();
    }
